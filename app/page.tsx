  ...
  return (
    <main className="font-sans mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-10 px-4 py-10">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-center">Twitter Archive FAQ</h2>
        <dl className="space-y-4">
          {faqEntries.map((entry) => (
            <div key={entry.question} className="rounded-lg border p-4">
              <dt className="text-lg font-medium">{entry.question}</dt>
